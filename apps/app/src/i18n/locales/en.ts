...
export default {
  ...
  "connect.status_checking": "Checking",
  "connect.status_checking_desc": "Checking connected service tools in the background.",
  "connect.status_needs_attention": "Needs attention",
  "connect.status_needs_attention_desc": "OpenWork Connect could not verify connected service tools. Run diagnostics for details.",
  "connect.status_ready": "Ready",
  "connect.status_ready_desc": "Connected service tools are available.",
  "connect.status_restoring_desc": "Restoring connected service tools ({attempt}/{maxAttempts}).",
