...
export default {
  ...
  "composer.connect_provider_desc": "Add an API key for Anthropic, OpenAI, Google, or other providers so tasks can run.",
  "composer.connect_provider_title": "Connect a model provider",
  ...
  "composer.free_starter_model": "Using the free starter model.",
  "composer.frontier_models_cta": "Get frontier models with no API keys",
  "composer.hero_subtitle": "Describe it in plain language",
  "composer.hero_title": "What do you need done?",
  "composer.hide_models_hint": "Hide OpenWork Models hint",
  ...
  "composer.no_mcp_servers": "No MCP servers loaded.",
  "composer.open_connect": "Open Connect",
  "composer.preparing_workspace": "Preparing your workspace…",
  ...
  "composer.stop": "Stop",
  "composer.suggestion_document_desc": "Reports, emails, or briefs from a few bullet points.",
  "composer.suggestion_document_title": "Draft a document",
  "composer.suggestion_spreadsheet_desc": "Drop in a CSV and describe the result you want.",
  "composer.suggestion_spreadsheet_title": "Clean up a spreadsheet",
  "composer.suggestion_summarize_desc": "Pull highlights from email and calendar.",
  "composer.suggestion_summarize_title": "Summarize my week",
  "composer.suggestion_web_desc": "Use the built-in browser for repetitive steps.",
  "composer.suggestion_web_title": "Automate a web task",
  "composer.tools_label": "Commands, skills, and MCPs",
  "composer.tools_prepare_failed": "Connected service tools could not be prepared.",
  ...
  "connect.attention_title": "One possible issue: {description}",
  ...
  "den.cloud_provider_blocked": "Unavailable on this desktop",
  "den.cloud_provider_conflict": "Conflict",
  "den.cloud_provider_connected": "Connected",
  "den.cloud_provider_error": "Sync error",
  "den.cloud_provider_imports_unavailable": "Imports unavailable in this workspace",
  "den.cloud_provider_needs_credential": "Needs organization credential",
  "den.cloud_provider_needs_server": "Needs OpenWork server",
  "den.cloud_provider_retry": "Retry",
  "den.cloud_provider_syncing": "Syncing",
  ...
  "den.cloud_providers_hint": "Providers granted by your organization sync automatically. Review their status here.",
  ...
  "den.import_plugin": "Import plugin",
  "den.import_provider": "Import",
  "den.imported_badge": "Imported",
  "den.importing_plugin": "Importing plugin...",
  ...
  "extensions.inventory_description": "Skills, connections, and tools your agent can use.",
  ...
  "settings.card_advanced_desc": "Runtime, engine, and developer options.",
  "settings.card_ai_desc": "Connect services that provide AI models.",
  "settings.card_appearance_desc": "Theme, font size, and display.",
  "settings.card_cloud_desc": "OpenWork Cloud account and organization.",
  "settings.card_environment_desc": "Environment variables and paths.",
  "settings.card_permissions_desc": "Authorized folders and file access.",
  "settings.card_preferences_desc": "Default model, reasoning, and compaction.",
  "settings.card_recovery_desc": "Reset onboarding and clear data.",
  "settings.card_updates_desc": "App version and update channel.",
  "settings.group_help": "Help",
  "settings.models_connect": "Connect",
  "settings.models_connect_desc": "Hosted frontier models without managing API keys.",
  "settings.models_dismiss_aria": "Dismiss OpenWork Models banner",
  "settings.models_hosted_desc": "Hosted frontier models for OpenWork tasks without managing provider API keys.",
  "settings.models_managed_badge": "Managed by OpenWork Cloud",
  "settings.models_no_api_key": "No API key setup",
  "settings.models_not_connected": "Not connected",
  "settings.models_pricing_desc": "Pricing is handled through OpenWork Cloud. You can continue using OpenCode Zen or your own providers.",
  "settings.models_refresh": "Refresh models",
  "settings.models_subscribe": "Subscribe",
  "settings.models_syncing_badge": "Included — finish syncing",
  "settings.models_syncing_desc": "Your plan includes OpenWork Models, but they are not ready in this workspace yet.",
  "settings.models_title": "OpenWork Models",
  "settings.overview_all_settings": "Overview of all settings",
  ...
  "status.account_and_status": "Account and status",
  "status.action_feedback_desc": "Open the OpenWork feedback surface from the account menu.",
  "status.action_open_docs": "Open OpenWork docs",
  "status.action_open_docs_desc": "Open the documentation from the account menu.",
  "status.action_open_settings": "Open settings from the account menu",
  "status.action_open_settings_desc": "Use the account menu in the sidebar footer.",
  "status.action_send_feedback": "Send feedback",
  "status.hosted_frontier_models": "hosted frontier models",
  "status.restoring_session": "Restoring your session",
  "status.run_diagnostics": "Run diagnostics",
  "status.sync_with_cloud": "Sync with OpenWork Cloud",
  ...
  "settings.tab_description_cloud_providers": "Review organization LLM provider sync status.",
